...
syntax region  typescriptFuncCallArg contained
  ...
  \ start=/(/ end=/)/
  \ contains=@typescriptValue,@typescriptComments,typescriptFuncCallArgComma
  \ nextgroup=@typescriptSymbols,typescriptDotNotation
  \ skipwhite skipempty skipnl
syntax region  typescriptEventFuncCallArg      contained matchgroup=typescriptParens start=/(/ end=/)/ contains=@typescriptEventExpression
syntax region  typescriptEventString           contained start=/\z(["']\)/  skip=/\\\\\|\\\z1\|\\\n/  end=/\z1\|$/ contains=typescriptASCII,@events
syntax match   typescriptFuncCallArgComma /,/ contained
  \ nextgroup=@typescriptValue,@typescriptComments
  \ skipwhite skipempty skipnl
...
syntax region  typescriptObjectLiteral         matchgroup=typescriptBraces
  \ start=/{/ end=/}/
  \ contains=@typescriptComments,typescriptObjectLabel,typescriptStringProperty,typescriptComputedPropertyName,typescriptObjectComma
  \ fold contained

syntax match typescriptObjectComma /,/ contained
  \ nextgroup=@typescriptComments,typescriptObjectLabel,typescriptStringProperty,typescriptComputedPropertyName
  \ skipwhite skipnl
...
syntax cluster typescriptStatement
  ...
  \ typescriptModule,typescriptAliasKeyword,typescriptImport,typescriptEndColons
...
hi def link typescriptObjectComma          Exception
