...
require("lazy").setup({
    {"neoclide/coc.nvim", branch = "release"}, "folke/which-key.nvim",
    {"folke/neoconf.nvim", cmd = "Neoconf"}, "folke/neodev.nvim",
    "windwp/nvim-autopairs",
    {
        ...
        config = function() require("lvim.core.impatient") end
    },
    {"gcmt/wildfire.vim", config = function() require("lvim.core.wildfire") end},
    {"junegunn/goyo.vim"}, {
        "phaazon/hop.nvim",
    ...
    {"echasnovski/mini.map", branch = "stable", enabled = false}, {
        ...
        config = function() require("lvim.core.outline") end
